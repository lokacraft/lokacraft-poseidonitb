                        ...
                        <SwiperSlide>
                              <div className='flex w-full h-[300px] text-[#012169] rounded-xl bg-[#EFFBFF] flex-col items-center justify-center space-y-4'>
                                    ...
                                    <div className="w-[80%] mx-auto">
                                          <p className='text-md'>
                                          Ingat !!! Kesuksesan tidak jatuh gratis dari langit, tapi ia adalah kristalisasi dari kerja keras dan keringat, PERSEMBAHKAN KARYA YANG TERBAIKK, UNTUK NEGRI INIII !!!</p>
                                    </div>

...
const MenuBar: React.FC<MenuBarProps> = ({ editor }) => {
  ...
  return (
    <div className="control-group w-[60vw] mt-20 mx-auto">
...
const CreateArticle: React.FC = () => {
  return (
    <EditorProvider slotBefore={<MenuBar editor={useCurrentEditor().editor} />} extensions={extensions} content={content} />
  );
};
